...
<form autocomplete="off" method="POST" action="script/traitementDoublon.php">
  <div class="col-3">
...
<script>
  ...
  var countries = [
    <?php
    for ($i = 0; $i < count($nameTag); $i++) {
      // $nameTag[$i]['name'] = $pdo->quote($nameTag[$i]['name']);
      echo '"' . $nameTag[$i]['name'] . '",';
    }
    ?>
  ]
