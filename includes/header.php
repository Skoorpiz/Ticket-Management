...
<body>
  <nav class="navbar navbar-expand-lg navbar-light " style="background-color: #e3f2fd;">
    <div class="container-fluid">
      <a class="navbar-brand" href="/edsa-gestion_ticket/index.php">Home</a>
      <div class="collapse navbar-collapse" id="navbarNavAltMarkup">
        <div class="navbar-nav">
          <a class="nav-link active" aria-current="page" href="/edsa-gestion_ticket/detail.php">Détails</a>
          <div class="dropdown">
          ...
          <a class="nav-link active" aria-current="page" href="/edsa-gestion_ticket/ticket.php">Importation des tickets</a>
        </div>
      </div>
    </div>
    </div>
